...
async def checkout_order(
    ...
    """
    Create an order based on current user cart.
    Save order items, subtract items in stock and clear the cart.
    """
...
async def list_orders(
    ...
    """
    Return user orders with simple pagination.
    """
...
async def get_order(
    ...
    """
    Return detailed order info if it belongs to the user.
    """
